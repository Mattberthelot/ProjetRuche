...
INCLUDEPATH += "$${HOMEDIR}/ProjetRuche/software/batterieRuche/include"
INCLUDEPATH += "$${HOMEDIR}/ProjetRuche/software/batterieRuche/src"
...
INCLUDEPATH += "$${HOMEDIR}/.platformio/lib/Adafruit BusIO"
INCLUDEPATH += "$${HOMEDIR}/.platformio/lib/Adafruit GFX Library"
INCLUDEPATH += "$${HOMEDIR}/.platformio/lib/Adafruit INA219"
INCLUDEPATH += "$${HOMEDIR}/.platformio/lib/Adafruit NeoPixel"
INCLUDEPATH += "$${HOMEDIR}/.platformio/lib/Adafruit SSD1306"
